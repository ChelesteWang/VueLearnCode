  ...
  <el-container style="border: 1px solid #eee">
    ...
    <el-container>
      <el-header>
        ...
        <el-dropdown>
          <i class="el-icon-setting" style="margin-right: 15px"><span style="margin-left: 15px">欢迎回来，wxy</span></i>
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item width="100">返回前台</el-dropdown-item>
            <el-dropdown-item width="100">个人详情</el-dropdown-item>
...
const tableItem = {
  date: "2019-05-20", // 日期
  name: "wxy", // 姓名
  phone: "13678925815", // 电话
  address: "天津市河西区五大道485号 " // 地址
};
